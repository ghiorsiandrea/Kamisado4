...
public abstract class ArbitroMovimientosBasicosIlegales {
	...
	protected void realizarJugadasLegales(String[] jugadasLegales, Color[][] ultimosColores)
			throws MultipleFailuresError, CoordenadasIncorrectasException {
		int cont = 0;
	 ...
	 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
	 */
	protected void intentarJugadasIlegales(String[] jugadasIlegales) throws CoordenadasIncorrectasException {
